...
namespace ImproviSoft.System
{
    ...
    public class MusicManager : GameComponent
    {
        ...
        /// </summary>
        /// <param name="song">The song to play.</param>
        public void Play(Song song, bool isRepeating)
        {
            ...
            try {
                if (MediaPlayer.IsRepeating != isRepeating) {
                    MediaPlayer.IsRepeating = isRepeating;
                }
            }
            catch (Exception ex) {
                Debug.WriteLine(DateTime.Now + ": Error setting MediaPlayer.IsRepeating: " + ex.Message);
            }
        }
